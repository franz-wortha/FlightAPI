...
export interface ApiAirportAirport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AirportCode: Schema.Attribute.String & Schema.Attribute.Required;
    AirportName: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiFlightFlight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DestinationAirport: Schema.Attribute.Relation<
      'oneToOne',
      'api::airport.airport'
    >;
    ...
    > &
      Schema.Attribute.Private;
    OriginAirport: Schema.Attribute.Relation<
      'oneToOne',
      'api::airport.airport'
    >;
    publishedAt: Schema.Attribute.DateTime;
